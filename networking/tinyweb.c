...
/* this function handles the connection on the passed socket from the passed client
 * address. The connection is processed as a web request, and this function
 * replies over the connected socket. Finally, the passed socket is closed at the 
 * end of the function
 */
